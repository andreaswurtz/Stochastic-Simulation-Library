...
double peakHospitalization = 0.0; // Global variable to store the peak hospitalization

void trackPeakHospitalization(double time, const SymbolTable<std::string, double>& agentState) {
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Peak Hospitalization: " << peakHospitalization << "\n";
